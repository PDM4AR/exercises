...
from pdm4ar.exercises_def.ex10 import sim_context_from_yaml
...
if __name__ == '__main__':
    ...
    for c in configs:
        config_file = Path(__file__).parents[2] / "exercises_def/ex10" / c
