...
from pdm4ar.exercises_def.ex10.scenario import get_dgscenario
...
if __name__ == '__main__':
    ...
    from ex10 import load_config_ex10
    config_path = Path(__file__).parent / "config_1.yaml"
    config_dict = load_config_ex10(config_path)
    sim_context = get_sim_context(config_dict, seed=config_dict["seed"])
